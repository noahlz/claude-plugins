...
echo ""
echo "To finish setup, run the setup skill in your next Claude Code session:"
echo "  Use the dev-workflow:setup skill"
echo ""
echo "This creates the plugin resolver script needed by all dev-workflow skills."
echo "Background: https://github.com/anthropics/claude-code/issues/9354"
echo ""
